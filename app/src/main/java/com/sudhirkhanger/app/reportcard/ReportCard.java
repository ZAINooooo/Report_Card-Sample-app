...
public class ReportCard {
    ...
    private static final String SCHOOL_NAME = "SIR SYED UNIVERSITY";
    ...
    public ReportCard(int socialMarks, int chemistryMarks, int physicsMarks, int mathMarks, int englishMarks, String studentName, int rollNumber)
    {
    ...
    public String toString() {
        return "ReportCard{" + "studentName='" + studentName + '\'' + ", rollNumber=" + rollNumber + ", englishMarks=" + englishMarks + ", mathMarks=" + mathMarks + ", physicsMarks=" + physicsMarks + ", chemistryMarks=" + chemistryMarks + ", socialMarks=" + socialMarks + ", grade='" + getGrade(englishMarks, mathMarks, physicsMarks, chemistryMarks, socialMarks) + '\'' + '}';
    }
}
